            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        <img class="img-fluid w-100" src="<?=$row['foto']?>" alt="">
                    </div>
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        
                        <h3><a href="ccc"><?=$row['nama']?></a></h3>
    						<div class="pricing">
	    						<p class="price"><span><?="Rp " . number_format($row ['harga'], 2, ',', '.');?></span></p>
	    					</div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="form_pesanan.php" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>beli sekarang</a>
                        <a href="form_pesanan.php" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                    </div>
                </div>
            </div>
            <?php } ?>
                ...
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="d-flex flex-column justify-content-start">
                            ...
                            <a class="text-dark mb-2" href="shop.php"><i class="fa fa-angle-right mr-2"></i>belanja</a>
